...
from .nebolab_experiment_setup import NebolabSetup as nebo
# from .simulator.visualizer import DataLogger
# from .simulator.timeProfiling import timeProfiling
# from control_lib.commLaplacian import commLaplacian
# from .goToGoal import Pcontrol
...
class CCTAtoInit(Node):
    ...
    def si_to_TBTwist(u, theta):
        ...
        vel_ang = (- u[0]*np.sin(theta) + u[1]*np.cos(theta))/nebo.TB_L_SI2UNI
